...
TRIGGER_WORDS = ("мэри", "мери", "мари", "нейри", "гарри") # Триггер для работы Мэри
STOP_WORDS = ("стоп", "закончи встречу", "заверши встречу") # Триггеры для завершения работы бота

# Новые константы для стриминга (из ветки branch-for-merge)
...
ВАЖНО! Не записывай задачи для Мэри!
